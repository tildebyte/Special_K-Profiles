@echo off
cd /d "%~dp0"
copy /VY "C:\Users\quaestor\AppData\Local\Programs\Special K\Profiles\ONCE_HUMAN.exe\SpecialK-1440-SDR.ini" "C:\Users\quaestor\AppData\Local\Programs\Special K\Profiles\ONCE_HUMAN.exe\SpecialK.ini"
